...
elseif (VCPKG_CMAKE_SYSTEM_NAME STREQUAL "OHOS")
  # Unreal Engine does not ship a HarmonyOS-specific OpenSSL. It reuses the
  # Android ARM64 build for HarmonyOS (see HarmonyOSPlatform.Automation.cs and
  # the Harmony target platform), which works because both use a Linux-like
  # libc with clang, and UE's HarmonyOS HTTP stack links the same libraries.
  set(OPENSSL_INCLUDE_PATH "${OPENSSL_ROOT_DIR}/include/Android")
  if (VCPKG_TARGET_ARCHITECTURE STREQUAL "arm64")
    set(OPENSSL_LIB_PATH "${OPENSSL_ROOT_DIR}/lib/Android/ARM64")
  else()
    message(FATAL_ERROR "Unknown Unreal / OpenSSL paths for HarmonyOS (OHOS) platform with architecture ${VCPKG_TARGET_ARCHITECTURE}.")
  endif()
